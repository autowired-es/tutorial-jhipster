...
export class OfertaComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.ofertaService
      ...
      .subscribe(
        (res: HttpResponse<IOferta[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IOferta[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
