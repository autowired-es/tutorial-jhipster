...
import es.autowired.config.audit.AuditEventConverter;
import es.autowired.domain.PersistentAuditEvent;
...
import static es.autowired.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
