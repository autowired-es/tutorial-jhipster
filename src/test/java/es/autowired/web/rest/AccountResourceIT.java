...
import es.autowired.config.Constants;
import es.autowired.domain.User;
import es.autowired.repository.AuthorityRepository;
import es.autowired.repository.UserRepository;
import es.autowired.security.AuthoritiesConstants;
import es.autowired.service.UserService;
import es.autowired.service.dto.PasswordChangeDTO;
import es.autowired.service.dto.UserDTO;
import es.autowired.web.rest.vm.KeyAndPasswordVM;
import es.autowired.web.rest.vm.ManagedUserVM;
...
import static es.autowired.web.rest.AccountResourceIT.TEST_USER_LOGIN;
